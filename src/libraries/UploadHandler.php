...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => \Config::get('nccms::upload.dir'),
            'upload_url' => \Config::get('nccms::upload.url'),
            'user_dirs' => false,
            'mkdir_mode' => \Config::get('nccms::upload.mkdir_mode'),
            'param_name' => \Config::get('nccms::upload.param_name'),
            ...
            */
            ...
            'image_versions' => array(
                ...
                'medium' => array(
                    'max_width' => (Settings::getMediumW()) ? Settings::getMediumW():500,
                    'max_height' => (Settings::getMediumH()) ? Settings::getMediumH():500
                ),
                'thumbnail' => array(
                    ...
                    'crop' => true,
                    'max_width' => (Settings::getThumbW()) ? Settings::getThumbW():100,
                    'max_height' => (Settings::getThumbH()) ? Settings::getThumbH():100
                )
            )
        );
        if ($options) {
