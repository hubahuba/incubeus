@extends('nccms::layouts.ckeditor')
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-xs-6">
            <div class="small-box bg-blue dropdown notifications-menu" style="min-height: 116px;">
                ...
                @else
                <a href="#" class="small-box-footer" onclick="javascript:showOption(this);" data-thumbnail="{{{ \Config::get('app.url') . $media['thumbnail'] }}}" data-medium="{{{ \Config::get('app.url') . $media['medium'] }}}" data-origin="{{{ \Config::get('app.url') . $media['large'] }}}">
                    Add <i class="fa fa-arrow-circle-right"></i>
                </a>
                @endif
            </div>
